...
import { moApi } from '../services/endpoints.js';
import { useSnackbar } from '../context/SnackbarContext.jsx';

export default function MOQueue() {
  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        <Typography variant="h5">Medical Officer Queue</Typography>
              ...
              <TableBody>
                {filtered.map((r) => (
                  <TableRow key={r.id} hover>
                    <TableCell><Chip size="small" color="warning" label={r.caseNumber} /></TableCell>
                    ...
                    <TableCell align="right">
                      <Button
                        ...
                        onClick={() => navigate(`/mo/visit/${r.id}`)}
                      >
                        Attend
                      </Button>
                    </TableCell>
